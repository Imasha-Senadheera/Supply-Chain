 ...
 * ```
 */
export declare function isType(expr: Cypher.Expr, type: Type | Type[]): IsType;
/**
 ...
 * ```
 */
export declare function isNotType(expr: Cypher.Expr, type: Type | Type[]): IsType;
declare class ListType {
    private types;
    private _notNull;
    constructor(type: Type[]);
    notNull(): this;
    getCypher(env: Cypher.Environment): string;
}
export declare class IsType extends CypherASTNode {
    ...
    private not;
    private _notNull;
    constructor(expr: Cypher.Expr, type: Type[], not?: boolean);
    notNull(): this;
    getCypher(env: Cypher.Environment): string;
}
