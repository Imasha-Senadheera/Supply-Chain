...
function createConnectOrCreateAndParams({ input, varName, parentVar, relationField, refNode, node, context, withVars, callbackBucket, }) {
    ...
    const wrappedQueries = statements.map((statement) => {
        ...
        const callStatement = new cypher_builder_1.default.Call(cypher_builder_1.default.concat(statement, returnStatement)).importWith(...withVarsVariables);
...
function createConnectOrCreatePartialStatement({ input, baseName, parentVar, relationField, refNode, node, context, callbackBucket, withVars, }) {
    ...
    if (authorizationAfterPredicateReturn.predicate) {
        if (authorizationAfterPredicateReturn.preComputedSubqueries &&
            ...
            mergeQuery = cypher_builder_1.default.concat(mergeQuery, new cypher_builder_1.default.With(new cypher_builder_1.default.NamedVariable("*")), authorizationAfterPredicateReturn.preComputedSubqueries, new cypher_builder_1.default.With(new cypher_builder_1.default.NamedVariable("*")).where(authorizationAfterPredicateReturn.predicate));
        }
        else {
