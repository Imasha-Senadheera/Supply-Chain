...
const FulltextScoreField_1 = require("../../ast/fields/FulltextScoreField");
const FulltextScoreFilter_1 = require("../../ast/filters/property-filters/FulltextScoreFilter");
...
class FulltextFactory {
    ...
    createFulltextOperation(entity, resolveTree, context) {
        ...
        if (fulltextOperationDeprecatedFields) {
            ...
            sortOptions = {
                ...
                sort: (0, utils_1.filterTruthy)((sortOptions.sort || []).map((field) => field[entity.singular] || field)),
            };
            ...
            if (scoreWhere) {
                scoreFilter = new FulltextScoreFilter_1.FulltextScoreFilter({
    ...
    createFulltextScoreField(field, scoreVar) {
        return new FulltextScoreField_1.FulltextScoreField({
            alias: field.alias,
            score: scoreVar,
        });
    }
