...
class QueryAST {
    ...
    buildNew(neo4jGraphQLContext, varName) {
        ...
        return cypher_builder_1.default.concat(...clauses, returnClause);
    }
    /**
    ...
    buildQueryASTContext(neo4jGraphQLContext, varName = "this") {
        ...
        const returnVariable = new cypher_builder_1.default.NamedVariable(varName);
    ...
    getTargetFromOperation(neo4jGraphQLContext, varName) {
        if (this.operation instanceof ReadOperation_1.ReadOperation ||
            ...
            return (0, create_node_from_entity_1.createNodeFromEntity)(this.operation.target, neo4jGraphQLContext, varName);
        }
        if (this.operation instanceof AggregationOperation_1.AggregationOperation) {
            return (0, create_node_from_entity_1.createNodeFromEntity)(this.operation.entity, neo4jGraphQLContext, varName);
        }
    }
    print() {
