...
class ReadOperation extends operations_1.Operation {
    constructor({ target, relationship, directed, selection, }) {
        super();
        this.fields = [];
        this.filters = [];
        this.authFilters = [];
    ...
    transpile(context) {
        ...
        let subqueries;
        if (this.relationship) {
            subqueries = cypher_builder_1.default.concat(...fieldSubqueries, ...cypherFieldSubqueries, ...sortSubqueries);
        }
        else {
            subqueries = cypher_builder_1.default.concat(...fieldSubqueries);
            let sortClause;
            ...
            sortAndLimitBlock = this.hasCypherSort()
                ? cypher_builder_1.default.concat(...cypherFieldSubqueries, sortBlock)
                : cypher_builder_1.default.concat(sortBlock, ...cypherFieldSubqueries);
        }
        let clause;
        if (isCreateSelection && !this.relationship) {
            ...
            clause = cypher_builder_1.default.concat(filterSubqueriesClause, filterSubqueryWith, sortAndLimitBlock, subqueries, ret);
        }
        else {
            ...
            clause = cypher_builder_1.default.concat(...matchBlock, ...authFilterSubqueries, filterSubqueriesClause, filterSubqueryWith, sortAndLimitBlock, subqueries, ret);
        }
        return {
            clauses: [clause],
