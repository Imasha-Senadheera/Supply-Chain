...
class CompositeReadPartial extends ReadOperation_1.ReadOperation {
    ...
    transpileNestedCompositeRelationship(entity, context) {
        ...
        const clause = cypher_builder_1.default.concat(...extraMatches, matchClause, ...authFilterSubqueries, subqueries, ...sortSubqueries, ret);
        return {
            clauses: [clause],
    ...
    transpileTopLevelCompositeEntity(context) {
        ...
        const subqueries = cypher_builder_1.default.concat(...this.getFieldsSubqueries(nestedContext), ...cypherFieldSubqueries);
        const ret = this.getProjectionClause(nestedContext, context.returnVariable);
        const clause = cypher_builder_1.default.concat(...extraMatches, matchClause, ...authFilterSubqueries, subqueries, ret);
        return {
            clauses: [clause],
