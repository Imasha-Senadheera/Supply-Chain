...
class CompositeAggregationPartial extends QueryASTNode_1.QueryASTNode {
    ...
    getSubqueries(context) {
        ...
        let pattern;
        const targetNode = (0, create_node_from_entity_1.createNodeFromEntity)(this.target, context.neo4jGraphQLContext);
        ...
        if (this.entity instanceof RelationshipAdapter_1.RelationshipAdapter) {
            const relVar = (0, create_node_from_entity_1.createRelationshipFromEntity)(this.entity);
            ...
            return [
                cypher_builder_1.default.concat(matchClause, ...nestedSubqueries, new cypher_builder_1.default.Return([targetNode, "node"], [relVar, "edge"])),
            ];
        }
        else {
            pattern = new cypher_builder_1.default.Pattern(targetNode);
            const matchClause = new cypher_builder_1.default.Match(pattern).where(cypher_builder_1.default.and(...authFilterPredicates));
            const nestedSubqueries = (0, wrap_subquery_in_calls_1.wrapSubqueriesInCypherCalls)(context, this.getChildren(), [target]);
            return [cypher_builder_1.default.concat(matchClause, ...nestedSubqueries, new cypher_builder_1.default.Return([targetNode, "node"]))];
        }
    }
    print() {
