...
class AggregationOperation extends operations_1.Operation {
    ...
    createContext(parentContext) {
        if (this.entity instanceof RelationshipAdapter_1.RelationshipAdapter) {
            ...
            const targetNode = (0, create_node_from_entity_1.createNodeFromEntity)(this.entity.target, parentContext.neo4jGraphQLContext);
            ...
            const targetNode = (0, create_node_from_entity_1.createNodeFromEntity)(this.entity, parentContext.neo4jGraphQLContext);
