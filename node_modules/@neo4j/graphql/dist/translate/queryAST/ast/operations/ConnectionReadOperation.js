...
class ConnectionReadOperation extends operations_1.Operation {
    constructor({ relationship, directed, target, selection, }) {
        super();
        this.nodeFields = [];
    ...
    transpile(context) {
        ...
        const withCollectEdgesAndTotalCount = new cypher_builder_1.default.With([cypher_builder_1.default.collect(nodeAndRelationshipMap), edgesVar]).with(edgesVar, [cypher_builder_1.default.size(edgesVar), totalCount]);
        ...
        return {
            clauses: [
                cypher_builder_1.default.concat(...extraMatches, selectionClause, ...filtersSubqueries, withWhere, withCollectEdgesAndTotalCount, unwindAndProjectionSubquery, returnClause),
            ],
    ...
    createUnwindAndProjectionSubquery(context, edgesVar, returnVar) {
        ...
        return new cypher_builder_1.default.Call(cypher_builder_1.default.concat(unwindClause, ...prePaginationSubqueries, paginationWith, ...postPaginationSubqueries, new cypher_builder_1.default.Return([cypher_builder_1.default.collect(edgeProjectionMap), returnVar]))).importWith(edgesVar);
    }
