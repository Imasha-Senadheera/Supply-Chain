...
class RelationshipSelection extends EntitySelection_1.EntitySelection {
    ...
    apply(context) {
        ...
        const relVar = (0, create_node_from_entity_1.createRelationshipFromEntity)(this.relationship);
        const relationshipTarget = this.targetOverride ?? this.relationship.target;
        const targetNode = (0, create_node_from_entity_1.createNodeFromEntity)(relationshipTarget, context.neo4jGraphQLContext, this.alias);
