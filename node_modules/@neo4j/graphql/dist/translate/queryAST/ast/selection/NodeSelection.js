...
class NodeSelection extends EntitySelection_1.EntitySelection {
    ...
    apply(context) {
        ...
        if (this.useContextTarget) {
            ...
            node = context.target;
            matchPattern = new cypher_builder_1.default.Pattern(node).withoutLabels();
        }
        else {
            node = (0, create_node_from_entity_1.createNodeFromEntity)(this.target, context.neo4jGraphQLContext, this.alias);
        }
