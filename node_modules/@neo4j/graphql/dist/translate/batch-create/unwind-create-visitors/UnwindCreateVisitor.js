...
class UnwindCreateVisitor {
    ...
    visitCreate(create) {
        ...
        const relationshipValidationClause = new cypher_builder_1.default.Raw((env) => {
        ...
        this.clause = new cypher_builder_1.default.Call(clause).importWith(this.unwindVar);
        return this.clause;
    }
    visitNestedCreate(nestedCreate) {
        ...
        subQueryStatements.push(new cypher_builder_1.default.Return([cypher_builder_1.default.collect(cypher_builder_1.default.Null), new cypher_builder_1.default.Variable()]));
        ...
        return cypher_builder_1.default.concat(outsideWith, callClause);
    }
    ...
    getAuthorizationFieldClause({ astNode, nodeRef, unwindVar, }) {
        ...
        for (const field of usedAuthFields) {
            ...
            const authorizationPredicateReturn = (0, create_authorization_after_predicate_1.createAuthorizationAfterPredicateField)({
                context: this.context,
                nodes: [
                    {
                        variable: nodeRef,
...
function getAutoGeneratedFields(graphQLElement, cypherNodeRef) {
    ...
    autogeneratedIdFields.forEach((field) => {
        if (field.dbPropertyName) {
            setParams.push([cypherNodeRef.property(field.dbPropertyName), cypher_builder_1.default.randomUUID()]);
        }
    });
    return setParams;
}
