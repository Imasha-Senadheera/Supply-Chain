...
exports.WarnObjectFieldsWithoutResolver = exports.VALIDATE_OBJECT_FIELD_WARN_MSG = void 0;
                ...
                for (const fieldNode of objectType.fields ?? []) {
                    ...
                    if (typeNeedsResolver(innerType, context.getDocument())) {
                        ...
                        if (!hasResolvableDirective && !hasCustomResolver) {
                            ...
                            console.warn(`${exports.VALIDATE_OBJECT_FIELD_WARN_MSG} ${fieldName}`);
                        }
                    }
                }
            },
...
function getDirectiveNames(field) {
    ...
    return (0, utils_1.filterTruthy)(fieldDirectives.map((d) => d.name.value));
}
