...
exports.withConnectWhereFieldInputType = exports.withSourceWhereInputType = exports.withWhereInputType = exports.withUniqueWhereInputType = void 0;
...
function withWhereInputType({ entityAdapter, userDefinedFieldDirectives, features, composer, typeName = entityAdapter.operations.whereInputTypeName, returnUndefinedIfEmpty = false, alwaysAllowNesting, }) {
...
function withSourceWhereInputType({ relationshipAdapter, composer, deprecatedDirectives, userDefinedDirectivesOnTargetFields, }) {
    ...
    if (relationshipTarget instanceof UnionEntityAdapter_1.UnionEntityAdapter || relationshipTarget instanceof InterfaceEntityAdapter_1.InterfaceEntityAdapter) {
        return;
    }
